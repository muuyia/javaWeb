...
| cainiao_Servlet       |                    |                                    |                                                               |
| cainiao_Servlet       |    PageRedirect    |               页面重定向                |                                                               |
| cainiao_Servlet       |      Refresh       |               自动刷新页面               |                                                               |
| cainiao_Servlet       |                    |                                    |                                                               |
| cainiao_Servlet       |                    |                                    |                                                               |
| cainiao_Servlet       |                    |                                    |                                                               |
...
| demo07                |                    |                域对象                 |                                                               |
| demo10-ajax           |                    |                                    |                    Application Context  /                     |
...
# 前端
### 工程创建
新建工程目录 D:\workspace\Study_VUE\atguigu-all\demo5-npm
cmd窗口执行初始化  npm init
...
现象：test测试类可以成功操作数据库，Servlet调用失败
更换JAVA版本，重新构建
https://blog.csdn.net/weixin_45703991/article/details/125627645


### 部署到实际Tomcat后Servlet无法访问
开发环境和生产环境java版本不一致